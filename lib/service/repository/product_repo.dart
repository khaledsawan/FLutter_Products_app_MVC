...
class ProductRepo extends GetxService {
  ...
  Future<Response> show(ProductId view_id) async {
    print(view_id.id);
    print("view_id.id");
    return await apiClient.postData(AppConstants.PRODUCT_URL_SHOW,view_id.toJson());
  }
  Future<Response> update(UpdateProductModel updateProductModel) async {
    ...
    print("view_id.id");
    return await apiClient.postData(AppConstants.PRODUCT_URL_SHOW,updateProductModel.toJson());
  }
}
