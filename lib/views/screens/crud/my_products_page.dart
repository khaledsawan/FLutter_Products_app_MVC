...
class MyProductsPage extends StatefulWidget {
  const MyProductsPage(ProductController productController, {Key? key})
      : super(key: key);
      ...
      content: Container(
          ...
          child: Center(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  productController.destroy_product(ProductId(id: id));
                  Navigator.of(context, rootNavigator: true).pop();
        ...
        child: GetBuilder<ProductController>(
          builder: (controller) {
            return controller.isLoaded
                ...
                : controller.MyProductList.length != 0
                    ? ListView.builder(
                    ...
                    : Center(
                        child: Image.asset('images/assets/getData.png'),
                      );
          },
        ));
  }
